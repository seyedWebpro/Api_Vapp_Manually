...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api_Vapp.Models.AppBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_Vapp.Models.AppNewsTickerMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_Vapp.Models.AutomationTypeDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_Vapp.Models.InAppNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_Vapp.Models.NumberSeekerPhoneBank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("City", "Category", "Source", "IsDeleted", "IsAvailable");

                    b.ToTable("NumberSeekerPhoneBanks");
                });
            ...
            modelBuilder.Entity("Api_Vapp.Models.ProfessionalCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProfessionalCampaigns");
                });

            modelBuilder.Entity("Api_Vapp.Models.ProfessionalCampaignRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProfessionalCampaignId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProfessionalCampaignId", "MobileNumber")
                        .IsUnique();

                    b.ToTable("ProfessionalCampaignRecipients");
                });

            modelBuilder.Entity("Api_Vapp.Models.ProfessionalCampaignStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProfessionalCampaignId", "StepOrder")
                        .IsUnique();

                    b.HasIndex("Status", "ScheduledAtUtc");

                    b.ToTable("ProfessionalCampaignSteps");
                });
            ...
            modelBuilder.Entity("Api_Vapp.Models.SmsApprovalRequest", b =>
                {
                    ...
                    b.Property<int?>("ProfessionalCampaignStepId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProfessionalCampaignStepId");
            ...
            modelBuilder.Entity("Api_Vapp.Models.SmsPricingSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CountLeadingTrailingSpaces")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("DefaultLanguageIsPersian")
                        .HasColumnType("bit");

                    b.Property<int>("EmojiCharWeight")
                        .HasColumnType("int");

                    b.Property<int>("EnglishFirstPageChars")
                        .HasColumnType("int");

                    b.Property<int>("EnglishOtherPagesChars")
                        .HasColumnType("int");

                    b.Property<bool>("IncludeOptOutSuffixInCalculation")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("LanguageDetectionSampleLength")
                        .HasColumnType("int");

                    b.Property<int>("MaxPages")
                        .HasColumnType("int");

                    b.Property<string>("OptOutSuffix")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<int>("PersianFirstPageChars")
                        .HasColumnType("int");

                    b.Property<int>("PersianOtherPagesChars")
                        .HasColumnType("int");

                    b.Property<int>("PersianSecondPageChars")
                        .HasColumnType("int");

                    b.Property<int>("RegularCharWeight")
                        .HasColumnType("int");

                    b.Property<int>("SpaceCharWeight")
                        .HasColumnType("int");

                    b.Property<bool>("TrimContentBeforeCount")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("SmsPricingSettings", (string)null);
                });
            ...
            modelBuilder.Entity("Api_Vapp.Models.UserDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_Vapp.Models.UserOccasionPreference", b =>
                {
                    ...
                    b.Property<bool>("ApplyToAllContacts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<string>("ContactIdsJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");

                    b.Property<string>("ContactNotebookIdsJson")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("ExcludedContactIdsJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("Api_Vapp.Models.WalletReferralReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ReferrerWalletTransactionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReferrerWalletTransactionId");

                    b.ToTable("WalletReferralRewards", (string)null);
                });

            modelBuilder.Entity("Api_Vapp.Models.WalletReferralSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WalletReferralSettings", (string)null);
                });
            ...
            modelBuilder.Entity("Api_Vapp.Models.ZohalInquiryLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("NationalCodeMasked")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("UserFacingErrorCode")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<int?>("ZohalResultCode")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MobileMasked");

                    b.HasIndex("TraceId");

                    b.HasIndex("InquiryType", "CreatedAt");

                    b.HasIndex("OutcomeStatus", "CreatedAt");

                    b.ToTable("ZohalInquiryLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Api_Vapp.Models.ProfessionalCampaignRecipient", b =>
                {
                    ...
                    b.HasOne("Api_Vapp.Models.ProfessionalCampaign", "ProfessionalCampaign")
                        .WithMany("Recipients")
                        .HasForeignKey("ProfessionalCampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Contact");

                    b.Navigation("ProfessionalCampaign");
                });
            ...
            modelBuilder.Entity("Api_Vapp.Models.SmsApprovalRequest", b =>
                {
                    ...
                    b.HasOne("Api_Vapp.Models.ProfessionalCampaignStep", "ProfessionalCampaignStep")
                        .WithMany()
                        .HasForeignKey("ProfessionalCampaignStepId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("ProfessionalCampaignStep");
            ...
            modelBuilder.Entity("Api_Vapp.Models.WalletReferralReward", b =>
                {
                    b.HasOne("Api_Vapp.Models.User", "BeneficiaryUser")
                        .WithMany()
                    ...
                    b.HasOne("Api_Vapp.Models.User", "ReferrerUser")
                        .WithMany()
                        .HasForeignKey("ReferrerUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Api_Vapp.Models.WalletTransaction", "ReferrerWalletTransaction")
                        .WithMany()
                        .HasForeignKey("ReferrerWalletTransactionId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("ReferrerWalletTransaction");
                });
