...
namespace Api_Vapp.Controller.Admin
{
    ...
    public class MessageApprovalController : VappControllerBase
    {
        private readonly IAdminMessageApprovalService _service;

        public MessageApprovalController(
            IAdminMessageApprovalService service,
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<ApiResponse<SmsApprovalRequestResponseDto>>> GetById(int id)
        {
