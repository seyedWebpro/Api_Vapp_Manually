...
namespace Api_Vapp.Controller
{
    ...
    public class MessageController : VappControllerBase
    {
        ...
        /// </summary>
        /// <param name="quickSendDto">اطلاعات شامل شناسه مخاطب و قالب منتخب ارسال سریع</param>
        ...
        /// 2. اعتبارسنجی و انتخاب یکی از قالب‌های منتخب ارسال سریع کاربر
        ...
        /// - Notebook: انتخاب تمام مخاطبین یک یا چند دفترچه
        /// - Tag: انتخاب تمام مخاطبینی که تگ خاصی دارند
