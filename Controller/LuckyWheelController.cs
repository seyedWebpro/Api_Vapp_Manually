...
namespace Api_Vapp.Controller
{
    ...
    public class LuckyWheelController : VappControllerBase
    {
        ...
        /// <summary>
        /// ارسال سریع لینک گردونه به یک مخاطب (SMS)
        /// </summary>
        [HttpPost("quick-send")]
        ...
        public async Task<ActionResult<ApiResponse<DirectSendResultDto>>> QuickSendLuckyWheel(
            [FromBody] QuickSendLuckyWheelDto? quickSendDto)
        {
            ...
            var userId = await GetCurrentUserIdAsync();
            var result = await _luckyWheelService.QuickSendLuckyWheelAsync(userId, quickSendDto);
            return StatusCode(result.StatusCode, result);
        }
    }
}
