...
namespace Api_Vapp.Interfaces
{
    ...
    public interface IContactNotebookService
    {
        ...
        Task<ApiResponse<ContactNotebookListResponseDto>> GetNotebooksAsync(int userId, int pageNumber = 1, int pageSize = 20, bool? isActive = null, string? searchTerm = null);
