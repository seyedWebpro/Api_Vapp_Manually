...
{
    public static class BusinessCardSlugHelper
    {
        ...
        public static string? Normalize(string? slug)
        {
            ...
            return normalized.Length > BusinessCardConstants.MaxSlugLength
                ? normalized[..BusinessCardConstants.MaxSlugLength].Trim('-')
                : normalized;
        }
