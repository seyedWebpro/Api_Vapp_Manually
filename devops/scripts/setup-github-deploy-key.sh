...
echo "  git clone git@github.com:seyedWebpro/PublicWeb_Vapp.git ~/Public_Vapp"
echo "  git clone git@github.com:seyedWebpro/scraping_Number_Vapp.git ~/scraping_Number_Vapp"
echo ""
