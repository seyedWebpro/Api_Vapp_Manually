...
> **Mac → سرور (پورت 22، همین دیتاسنتر CaspianEdu):** [`MAC-SERVER.md`](MAC-SERVER.md)
...
**پورت SSH این سرور: `22`**. Alias: `vapp-prod`
...
# یا
ssh -p 22 -i ~/.ssh/id_ed25519_vapp_server root@195.24.237.132 'echo OK'
```
...
2. **New SSH key**
3. Title: `vapp-server-195.24.237.132`
...
| خطا | راه‌حل |
|-----|--------|
| `Permission denied (publickey)` به سرور | کلید Mac را در `authorized_keys` سرور بگذارید؛ `ssh-copy-id -p 22 ...` |
