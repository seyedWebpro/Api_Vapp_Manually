...
مثال لینک نهایی: `https://vapplication.ir/form/contact-form`
...
| چه می‌بینید | آدرس |
|-------------|------|
| صفحه فرم | `https://vapplication.ir/form/{slug}` |
| صفحه گردونه | `https://vapplication.ir/wheel/{slug}` |
| پنل ادمین | `https://vapplication.ir/` |
...
- فرم: `https://vapplication.ir/form/my-slug`
- گردونه: `https://vapplication.ir/wheel/my-slug`
...
Swagger: `https://vapplication.ir/swagger` → بخش‌های `FormPublic` و `LuckyWheelPublic`
...
| لینک SMS اشتباه | `docker exec vapp_api_prod printenv \| grep PublicBaseUrl` — باید `https://vapplication.ir/form` و `/wheel` باشد |
